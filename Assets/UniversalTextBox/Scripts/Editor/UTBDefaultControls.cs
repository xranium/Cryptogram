...
{
    public static class UTBDefaultControls
    {
        ...
        {
            GameObject root = CreateUIElementRoot("InputField - UTB", s_ThickElementSize);
            ...
            UTB text = childText.AddComponent<UTB>();
            text.text = "";
            ...
            UTB placeholder = childPlaceholder.AddComponent<UTB>();
        ...
        {
            GameObject root = CreateUIElementRoot("Dropdown - UTB", s_ThickElementSize);
            ...
            UTB itemLabelText = itemLabel.AddComponent<UTB>();
            ...
            UTB labelText = label.AddComponent<UTB>();
